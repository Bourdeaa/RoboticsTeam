...
U 1 1 619E1153
P 1900 1200
F 0 "#PWR0111" H 1900 950 50  0001 C CNN
...
F 1 "GND" H 4240 5245 50  0000 C CNN
...
F 1 "GND" H 4240 6390 50  0000 C CNN
...
F 1 "GND" H 2495 6390 50  0000 C CNN
...
F 1 "GND" H 2485 5185 50  0000 C CNN
...
U 1 1 61B52C10
P 4000 4100
F 0 "#PWR0134" H 4000 3950 50  0001 C CNN
F 1 "+5V" H 4000 4060 50  0000 C CNN
...
U 1 1 61B53671
P 4000 5350
F 0 "#PWR0135" H 4000 5200 50  0001 C CNN
F 1 "+5V" H 4000 5305 50  0000 C CNN
...
F 1 "+5V" H 2250 5245 50  0000 C CNN
...
U 1 1 61B55285
P 2250 6505
F 0 "#PWR0137" H 2250 6355 50  0001 C CNN
F 1 "+5V" H 2250 6460 50  0000 C CNN
F 2 "" H 2250 6505 50  0001 C CNN
F 3 "" H 2250 6505 50  0001 C CNN
	1    2250 6505
	-1   0    0    -1  
$EndComp
$Comp
...
U 1 1 61B559F4
P 4000 6500
F 0 "#PWR0138" H 4000 6350 50  0001 C CNN
F 1 "+5V" H 4000 6455 50  0000 C CNN
...
Wire Notes Line style solid
	4915 4430 4915 730 
Text Notes 4965 880  0    50   ~ 0
MotorDrivers (Steering Motors)\n
Text Notes 6415 3980 0    50   ~ 0
Timer 4 Channel 4\n
$Comp
L power:GND #PWR0139
U 1 1 61B01A45
P 6065 1880
F 0 "#PWR0139" H 6065 1630 50  0001 C CNN
F 1 "GND" H 6070 1707 50  0000 C CNN
F 2 "" H 6065 1880 50  0001 C CNN
F 3 "" H 6065 1880 50  0001 C CNN
	1    6065 1880
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	6065 1780 6065 1880
Text Notes 6415 1430 0    50   ~ 0
Timer9 Channel 1
Text GLabel 5765 1280 2    50   Input ~ 0
Steer1-INA2
Text GLabel 5765 1380 2    50   Input ~ 0
Steer1-PWMA
Text GLabel 5765 1480 2    50   Input ~ 0
Steer1-INB1
Text GLabel 5765 1580 2    50   Input ~ 0
Steer1-INB2
Text Notes 6415 1730 0    50   ~ 0
Timer9 Channel 2\n
Text Notes 6415 2630 0    50   ~ 0
Timer 4 Channel 1\n
Text Notes 6415 3180 0    50   ~ 0
Timer 4 Channel 2\n\n\n\n
NoConn ~ 5765 3080
$Comp
L power:GND #PWR0140
U 1 1 61B154EF
P 6065 3080
F 0 "#PWR0140" H 6065 2830 50  0001 C CNN
F 1 "GND" H 6070 2907 50  0000 C CNN
F 2 "" H 6065 3080 50  0001 C CNN
F 3 "" H 6065 3080 50  0001 C CNN
	1    6065 3080
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	6065 2980 6065 3080
Text GLabel 5765 2380 2    50   Input ~ 0
Steer2-INA1
Text GLabel 5765 2480 2    50   Input ~ 0
Steer2-INA2
Text GLabel 5765 2580 2    50   Input ~ 0
Steer2-PWMA
Text GLabel 5765 2680 2    50   Input ~ 0
Steer2-INB1
Text GLabel 5765 2780 2    50   Input ~ 0
Steer2-INB2
Text GLabel 5765 2880 2    50   Input ~ 0
Steer2-PWMB
NoConn ~ 5765 4130
$Comp
L power:GND #PWR0141
U 1 1 61B1BB48
P 6065 4130
F 0 "#PWR0141" H 6065 3880 50  0001 C CNN
F 1 "GND" H 6070 3957 50  0000 C CNN
F 2 "" H 6065 4130 50  0001 C CNN
F 3 "" H 6065 4130 50  0001 C CNN
	1    6065 4130
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	6065 4030 6065 4130
Text GLabel 5765 3430 2    50   Input ~ 0
Steer3-INA1
Text GLabel 5765 3530 2    50   Input ~ 0
Steer3-INA2
Text GLabel 5765 3630 2    50   Input ~ 0
Steer3-PWMA
Text GLabel 5765 3730 2    50   Input ~ 0
Steer3-INB1
Text GLabel 5765 3830 2    50   Input ~ 0
Steer3-INB2
Text GLabel 5765 3930 2    50   Input ~ 0
Steer3-PWMB
...
Steer1-PWMA
Text GLabel 5765 1680 2    50   Input ~ 0
Steer1-PWMB
...
U 1 1 61B72EFA
P 850 2245
F 0 "#PWR0146" H 850 1995 50  0001 C CNN
F 1 "GND" H 730 2225 50  0000 C CNN
F 2 "" H 850 2245 50  0001 C CNN
F 3 "" H 850 2245 50  0001 C CNN
	1    850  2245
	1    0    0    -1  
$EndComp
$Comp
...
F 6 "Manufacturer Recommendation" H 3550 6400 50  0001 L BNN "STANDARD"
	...
	1    0    0    -1  
$EndComp
Text GLabel 5765 1180 2    50   Input ~ 0
Steer1-INA1
$Comp
L DriverBoardSymbols:JST_XH_8POS J11
U 1 1 61BE2ED4
P 5765 1880
F 0 "J11" H 6015 930 60  0000 C CNN
F 1 "B8B-XH-ALFSN" H 6015 1030 60  0000 C CNN
F 2 "DriverBoard:JST8Way" H 6165 1620 60  0001 C CNN
F 3 "" H 5765 1880 60  0000 C CNN
	1    5765 1880
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 61BE4B37
P 5765 3080
F 0 "J12" H 6007 2093 60  0000 C CNN
F 1 "B8B-XH-ALFSN" H 6007 2199 60  0000 C CNN
F 2 "DriverBoard:JST8Way" H 6165 2820 60  0001 C CNN
F 3 "" H 5765 3080 60  0000 C CNN
	1    5765 3080
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 61BE5E84
P 5765 4130
F 0 "J13" H 6015 3180 60  0000 C CNN
F 1 "B8B-XH-ALFSN" H 6015 3280 60  0000 C CNN
F 2 "DriverBoard:JST8Way" H 6165 3870 60  0001 C CNN
F 3 "" H 5765 4130 60  0000 C CNN
	1    5765 4130
	-1   0    0    1   
$EndComp
$Comp
...
F 2 "MCP2562:MCP2562" H 13200 2450 50  0001 L BNN
...
F 2 "MCP2562:MCP2562" H 13250 4150 50  0001 L BNN
...
F 2 "MCP2562:MCP2562" H 13300 5850 50  0001 L BNN
...
U 1 1 61E01678
P 2350 7400
F 0 "#PWR0148" H 2350 7150 50  0001 C CNN
F 1 "GND" H 2440 7390 50  0000 C CNN
...
F 1 "GND" H 2485 9795 50  0000 C CNN
...
F 1 "GND" H 2485 8590 50  0000 C CNN
...
U 1 1 61E016AC
P 2200 7500
F 0 "#PWR0151" H 2200 7350 50  0001 C CNN
F 1 "+5V" H 2200 7450 50  0000 C CNN
...
U 1 1 61E016BE
P 2250 8700
F 0 "#PWR0152" H 2250 8550 50  0001 C CNN
...
U 1 1 61E016C4
P 2250 9900
F 0 "#PWR0153" H 2250 9750 50  0001 C CNN
F 1 "+5V" H 2250 9860 50  0000 C CNN
...
U 1 1 61E016CA
P 4000 9900
F 0 "#PWR0154" H 4000 9750 50  0001 C CNN
F 1 "+5V" H 4000 9825 50  0000 C CNN
...
U 1 1 61E016B8
P 4000 8750
F 0 "#PWR0155" H 4000 8600 50  0001 C CNN
F 1 "+5V" H 4000 8700 50  0000 C CNN
...
U 1 1 61E016B2
P 4000 7500
F 0 "#PWR0156" H 4000 7350 50  0001 C CNN
...
F 1 "GND" H 4235 9790 50  0000 C CNN
...
F 1 "GND" H 4235 8640 50  0000 C CNN
...
F 1 "GND" H 4235 7390 50  0000 C CNN
...
U 1 1 6245F100
P 3250 1400
F 0 "#PWR0110" H 3250 1250 50  0001 C CNN
...
U 1 1 6246033A
P 4250 1400
F 0 "#PWR0120" H 4250 1250 50  0001 C CNN
...
U 1 1 61A86B20
P 2350 4000
F 0 "#PWR0119" H 2350 3750 50  0001 C CNN
F 1 "GND" H 2440 3990 50  0000 C CNN
...
U 1 1 61B30B0D
P 2200 4100
F 0 "#PWR0133" H 2200 3950 50  0001 C CNN
F 1 "+5V" H 2200 4055 50  0000 C CNN
...
Wire Wire Line
	850  2245 850  2300
$Comp
L DriverBoardSymbols:JST_XH_3POS J8
U 1 1 62539FBC
P 5455 5465
F 0 "J8" H 5410 5235 50  0000 L CNN
F 1 "B3B-XH-A(LF)(SN)" H 5085 5700 50  0000 L CNN
F 2 "DriverBoard:JST3Way" H 5455 5465 50  0001 C CNN
F 3 "~" H 5455 5465 50  0001 C CNN
	1    5455 5465
	-1   0    0    1   
$EndComp
Text Notes 5065 5100 0    50   ~ 0
RC Out
NoConn ~ 10350 8100
NoConn ~ 10350 8000
NoConn ~ 10350 7900
